module managers
{
    export class ScoreBoard
    {
        ...
        {
            this._livesLabel = new objects.Label("Lives: 99", "20px", "Consolas", "#FFFFFF", 20, 20);
            this._scoreLabel = new objects.Label("Score: 99999", "20px", "Consolas", "#FFFFFF", 490, 20);
            this._highScoreLabel = new objects.Label("High Score: 99999", "40px", "Consolas", "#FFFFFF", 320, 290);
